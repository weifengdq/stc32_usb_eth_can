...
//========================================================================
// 函数: u16 CanReadStandardFrame(u8 *pdat)
// 描述: CAN读取标准帧函数。
// 参数: *pdat: 接收数据缓冲区.
// 返回: CAN ID.
// 版本: VER1.0
...
//========================================================================
// 函数: u32 CanReadExtendedFrame(u8 *pdat)
// 描述: CAN读取扩展帧函数。
// 参数: *pdat: 接收数据缓冲区.
// 返回: CAN ID.
// 版本: VER1.0
...
//========================================================================
// 函数: void CanSendStandardFrame(u16 canid, u8 *pdat)
// 描述: CAN发送标准帧函数。
...
//========================================================================
// 函数: void CanSendExtendedFrame(u32 canid, u8 *pdat)
// 描述: CAN发送扩展帧函数。
// 参数: canid: CAN ID; *pdat: 发送数据缓冲区.
// 返回: none.
// 版本: VER1.0
